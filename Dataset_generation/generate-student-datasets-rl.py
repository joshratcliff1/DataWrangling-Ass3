...
while (len(student_data_set_list2) < 20000):
  ...
  if (rec_id2 not in matched_rec_id_set2):
    student_data_set_list2.append(rl_dict2[rec_id2])
  i += 1
...
#print(len(student_data_set_list1))
#print(len(student_data_set_list2))

md5_str = ''

student_data_set_name1 =   'data_wrangling_rl1_2020_%s.csv' % (anu_id)
student_data_set_name2 =   'data_wrangling_rl2_2020_%s.csv' % (anu_id)
student_gt_data_set_name = 'data_wrangling_rlgt_2020_%s.csv' % (anu_id)
...
print('-'*40)
print()
print('Your student data sets for the third data wrangling 2020 assignment')
