...
def compare(blockA_dict, blockB_dict, recA_dict, recB_dict):
...
''' Step 6: Print the results to csv '''

def print_results():
    file_name = 'savedResults/test.csv'
...
dataset_A_list = ['datasets_test/clean/A-1000','datasets_test/little/A-1000','datasets_test/very/A-1000']
dataset_B_list = ['datasets_test/clean/B-1000','datasets_test/little/B-1000','datasets_test/very/B-1000']
truth_list = ['datasets_test/clean/true-1000','datasets_test/little/true-1000','datasets_test/very/true-1000']



datasetA_name = 'Dataset_generation/data_wrangling_rl1_2020_u7199704.csv'
datasetB_name = 'Dataset_generation/data_wrangling_rl2_2020_u7199704.csv'

headerA_line = True  # Dataset A header line available - True or False
headerB_line = True  # Dataset B header line available - True or False

# Name of the corresponding file with true matching record pair
truthfile_name = 'Dataset_generation/data_wrangling_rlgt_2020_u7199704.csv'
...
recA_dict, recB_dict, true_match_set, all_comparisons, loading_time = load()

# Create the blocking dictionaries
blockA_dict, blockB_dict, blocking_time = block(recA_dict,recB_dict)

# Create the similarity vector
...
class_match_set, class_nonmatch_set, classification_time = classify(sim_vec_dict)
